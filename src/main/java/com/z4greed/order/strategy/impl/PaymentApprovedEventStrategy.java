...
@Component
public class PaymentApprovedEventStrategy implements OrderSagaEventStrategy {
  ...
  public void execute(SagaContextDto sagaContextDto) {
    this.orderSagaStateManager.update(sagaContextDto, OrderStatusEnum.CONFIRMED, SagaStatusEnum.COMPLETED, EventTypeEnum.PAYMENT_APPROVED, null);
